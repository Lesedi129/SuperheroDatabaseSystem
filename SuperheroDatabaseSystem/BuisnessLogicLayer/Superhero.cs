...
namespace SuperheroDatabaseSystem
{
       public class Superhero
    {
        ...
        //Automatically determines the rank based on the exam score.
        public string Rank
        {
            get
            {
            ...
            public string ThreatLevel
        {
            get
            {
                // Determines the threat level based on the rank.
                switch (Rank)
                {
                    case "S":
        ...
        // This methods ensures the details of the superhero are displayed in a single line which is separated by commas.
